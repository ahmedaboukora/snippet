...
| \
# Étape 2 : xargs envoie chaque ligne à un worker bash en parallèle.
# -P : nombre de workers concurrents
# -n 1 : un projet par invocation
# -d '\n' : séparateur ligne (pas espace, car les chemins peuvent en contenir)
